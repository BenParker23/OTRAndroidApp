...
// If you have a compilation error here then you have to add a reference to
// ExKsoap2.jar to your project (you can find it in Libs folder in the generated
// zip file)
public class ExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope
{
	...
	static
	{
		classNames.put("http://idempiere.org/ADInterface/1_0^^WindowTabData", WindowTabData.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^DataField", DataField.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^LookupValue", LookupValue.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^RunProcessResponse", RunProcessResponse.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^ADLoginRequest", ADLoginRequest.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^ADLoginResponse", ADLoginResponse.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^StandardResponse", StandardResponse.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^outputField", OutputField.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^ModelSetDocAction", ModelSetDocAction.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^ModelSetDocActionRequest",
				ModelSetDocActionRequest.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^ModelRunProcess", ModelRunProcess.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^ModelRunProcessRequest", ModelRunProcessRequest.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^ModelCRUD", ModelCRUD.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^ModelCRUDRequest", ModelCRUDRequest.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^DataSet", DataSet.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^DataRow", DataRow.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^LookupValues", LookupValues.class);
		classNames.put("http://idempiere.org/ADInterface/1_0^^outputFields", OutputFields.class);
	}
	...
	protected void writeProperty(XmlSerializer writer, Object obj, PropertyInfo type) throws IOException
	{
		...
		if (!type.multiRef && qName[2] == null)
		{
			...
			// !!!!! If you have a compilation error here then you are using old
			// version of ksoap2 library. Please upgrade to the latest version.
			// !!!!! You can find a correct version in Lib folder from generated
			// zip file!!!!!
	...
	private Object createObject(Object soap, Class cl)
