...
public class ModelCRUDRequest extends AttributeContainer implements KvmSerializable
{
			...
			ExtendedSoapSerializationEnvelope __envelope)
	{
		...
		if (info.name.equals("ModelCRUD"))
		{
			...
			{
				Object j = obj;
				this.ModelCRUD = (ModelCRUD) __envelope.get(j, ModelCRUD.class, false);
			}
			return true;
		}
